...
class Pedido {
    ...
    public function getProductsByPedido(){
        $sql = "SELECT pr.*, lp.unidades FROM productos pr INNER JOIN lineas_pedidos lp ON pr.id = lp.producto_id WHERE lp.pedido_id = {$this->getId()}";
    ...
    public function save_linea(){
        ...
        foreach ($_SESSION['carrito'] as $element) {
            ...
            $insert = "INSERT INTO lineas_pedidos VALUES(null, {$pedido_id}, {$producto->id}, {$element['unidades']})";
